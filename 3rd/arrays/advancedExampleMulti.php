...
// echo $categories['subCategories']['samsung'][1]->name . ' Made In ' . $categories['subCategories']['samsung'][1]->madeIn[1];
echo $categories['subCategories']['apple'][1]->name . 
' colors : ' . $categories['subCategories']['apple'][1]->colors[1]->secondaryColors[1] , ',' .
